...
class ShoesFragment : Fragment() {
    ...
    override fun onCreateView(
        ...
        val sortSpinner: Spinner = view.findViewById(R.id.sSortOptions)
        ...
        val filterSpinner: Spinner = view.findViewById(R.id.sFilterOptions)
        ArrayAdapter.createFromResource(
            view.context,
            R.array.shoes_filter_options,
            android.R.layout.simple_spinner_item
        ).also { adapter ->
            adapter.setDropDownViewResource(android.R.layout.simple_spinner_dropdown_item)
        ...
        view.findViewById<Button>(R.id.sclothing).setOnClickListener {
            view.findNavController().navigate(R.id.action_shoesFragment_to_clothingFragment)
        }

        view.findViewById<Button>(R.id.sheadgear).setOnClickListener {
            view.findNavController().navigate(R.id.action_shoesFragment_to_headgearFragment)
        }

        view.findViewById<Button>(R.id.sweapons).setOnClickListener {
            view.findNavController().navigate(R.id.action_shoesFragment_to_weaponFragment)
        }
    ...
    inner class WearableListAdapter():
        ...
        override fun onBindViewHolder(holder: WeaponViewHolder, position: Int) {
            ...
            Glide.with(this@ShoesFragment).load(resources.getString(R.string.picture_base_url)+wearables[position].imagePath)
