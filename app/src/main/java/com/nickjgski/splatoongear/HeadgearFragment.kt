 ...
 */
class HeadgearFragment : Fragment() {
    ...
    override fun onCreateView(
        ...
        var view = inflater.inflate(R.layout.fragment_headgear, container, false)
        val recyclerView = view.findViewById<RecyclerView>(R.id.headgearList)
        recyclerView.adapter = adapter
        recyclerView.layoutManager = LinearLayoutManager(view.context)
        model = activity?.let { ViewModelProviders.of(it).get(GearViewModel::class.java)}

        model?.allHeadgear?.observe(
            this,
        ...
        val sortSpinner: Spinner = view.findViewById(R.id.hSortOptions)
        ...
        val filterSpinner: Spinner = view.findViewById(R.id.hFilterOptions)
        ArrayAdapter.createFromResource(
            view.context,
            R.array.headgear_filter_options,
            android.R.layout.simple_spinner_item
        ).also { adapter ->
            adapter.setDropDownViewResource(android.R.layout.simple_spinner_dropdown_item)
        ...
        view.findViewById<Button>(R.id.hweapons).setOnClickListener {
            view.findNavController().navigate(R.id.action_headgearFragment_to_weaponFragment)
        }

        view.findViewById<Button>(R.id.hclothing).setOnClickListener {
            view.findNavController().navigate(R.id.action_headgearFragment_to_clothingFragment)
        }
        view.findViewById<Button>(R.id.hshoes).setOnClickListener {
            view.findNavController().navigate(R.id.action_headgearFragment_to_shoesFragment)
        }
    ...
    inner class WearableListAdapter():
        ...
        override fun onBindViewHolder(holder: WeaponViewHolder, position: Int) {
            ...
            Glide.with(this@HeadgearFragment).load(resources.getString(R.string.picture_base_url)+wearables[position].imagePath)
